...
import 'middle_page_screen.dart';
  ...
  _loginToCubeChat(BuildContext context, CubeUser user) {
    ...
    CubeChatConnection.instance.login(user).then((cubeUser) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (BuildContext context) => MiddlePage())
      );
      */
  ...
  void _goDialogScreen(BuildContext context, CubeUser cubeUser) async {
    ...
    FlutterLocalNotificationsPlugin()
      ...
      if (payload == null) {
        ...
        */
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => MiddlePageScreen(cubeUser)),);
      } else {
